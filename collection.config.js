...
const collection = {
  ...
  name: "khmer-ricecakes-archive",

  // One sentence: what is this archive, and why does it matter?
  description:
    "A living archive of Khmer rice cakes, their ingredients, memories, and places where they are made and shared.",

  // Who is building this archive? Your name, as you want it shown.
  curator: "Sovichey RIM",

  // Where does your knowledge come from? A person, a place, a community.
  source: "To be gathered from Khmer rice cake makers, families, and local markets",
